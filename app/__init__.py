...
def restaurants():
    if request.method == 'GET':
        ...
        coords = get_gmaps_coordinates(data['startLocation'], data['endLocation'], (data['startInterval'], data['endInterval']), data['startTime'])
...
def directions():
    if request.method == 'GET':
        ...
        # directions = get_gmaps_directions(data[])
